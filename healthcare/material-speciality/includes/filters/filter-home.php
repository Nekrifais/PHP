					...
					<div class="col-md-12">
						<div class="row top-search">
							...
							<div class="col-md-9 header-text">
								...
								<p> <?php echo $filter_text; ?> </p>
							</div>
							
							<div class="col-md-3 text-center">
								<a href="<?php bloginfo('url'); ?>/map/" class="white-link">
									<img src="<?php bloginfo('template_url'); ?>/images/browse-map.png" style="height:130px" class="img-responsive"> 
									<span class="under-title">Все врачи на карте</span>
								</a>
							</div>
